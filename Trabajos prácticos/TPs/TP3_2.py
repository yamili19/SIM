...
class MontercarlooApp:
    def __init__(self, master):
        ...
        style = ttk.Style()
        style.configure("Treeview.Heading", font=('Calibri', 8, 'bold'), anchor="center", height=300)
        ...
        self.h_scroll = tk.Scrollbar(self.table_frame, orient=tk.HORIZONTAL, command=self.canvas.xview)
    ...
    def definirConclusion(self,vecEstado):
        ...
        #Consumo Promedio
        tex2 = "El consumo promedio semanal es de: " + str(vecEstado.consumoProm) + " metros cuadrados de acero"
    ...
    def funcPrincipal(self):
        ...
        for i in range(int(self.cantidad_numeros_entry.get())+1):
            ...
            if (i+1 > int(self.cantidad_numeros_var.get())):
                if ( i % 2 == 0):
                    self.table.insert("", 0, text=i, values=(vecEstado[0].rnd1, vecEstado[0].pedido,
                    ...
                    self.table.insert("", 0, text=i, values=(vecEstado[1].rnd1, vecEstado[1].pedido,
